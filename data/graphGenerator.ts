...
export function generateBarChartData() {
  ...
  const dataset1Max = Math.floor(Math.random() * magnitude);
  const dataset2Max = Math.floor(Math.random() * magnitude);
    ...
    datasets: [
      {
        ...
        data: selectedLabels.map(() => Math.floor(Math.random() * dataset1Max)),
      ...
      },
      {
        ...
        data: selectedLabels.map(() => Math.floor(Math.random() * dataset2Max)),
